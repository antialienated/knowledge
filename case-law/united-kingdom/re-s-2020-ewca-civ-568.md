...
citation: [2020] EWCA Civ 568
case_name: "Re S (Parental Alienation: Cult)"
date_decided: 2020-04-30
jurisdiction: 
last_reviewed: 2026-05-15
location_tags: ["united-kingdom", "england", "wales", "court-of-appeal", "parental-alienation", "cult-context", "mother-targeted"]
citation_strength: landmark — first explicit Court of Appeal recognition of PA framework in English law
---
...
1. **First explicit Court of Appeal recognition** of the PA framework in English law
2. **Gender-neutral authority** — the targeted parent was the mother, undermining the older cultural framing of PA as a fathers'-rights issue (consistent with Harman, Kruk & Hines 2018 finding that PA victimization is gender-symmetric)
3. **Set the foundation** for *Re C (Parental Alienation: Instruction of Expert)* [2023] EWHC 345 (Fam) which operationalized the expert-testimony framework
4. **Aligns with ECHR Solarino** (2017) — courts examining the origin of children's stated preferences
...
- [case-law/united-kingdom/re-c-2023-ewhc-345-fam.md](./re-c-2023-ewhc-345-fam.md) — operational successor
- [case-law/united-kingdom/re-h-n-2021-ewca-civ-448.md](./re-h-n-2021-ewca-civ-448.md) *(seed — DV/alienation overlap)*
- [case-law/echr/solarino-v-italy-2017.md](../echr/solarino-v-italy-2017.md) — aligned ECHR doctrine
- [research/harman-kruk-hines-2018.md](../../research/harman-kruk-hines-2018.md) — gender-symmetric prevalence
