...
case_name: Re W (Children) [2012] EWCA Civ 999
date_decided: 2012-07-19
jurisdiction: 
last_reviewed: 2026-05-16
location_tags: ["united-kingdom", "england", "wales", "court-of-appeal", "transfer-of-residence", "intractable-contact-dispute"]
neutral_citation: [2012] EWCA Civ 999
citation_strength: significant — leading UK Court of Appeal authority endorsing transfer of residence as remedy in entrenched alienation cases
---
...
1. Transfer of residence is a **legitimate remedy** in entrenched intractable-contact cases
2. The "draconian" nature of the remedy does not preclude its use where less intrusive remedies have demonstrably failed
3. Children's stated preferences cannot be the sole determining factor when those preferences appear to be the product of alienation
4. The trial judge's discretion deserves substantial appellate deference
...
1. **Multiple prior orders have been ignored** — typically 2-3+ orders over 18+ months
2. **Less intrusive remedies have demonstrably failed** — supervised contact, enforcement orders, fines
3. **Expert evidence supports the alienation finding** — typically Section 7 or appointed expert
4. **Transfer is workable** — receiving parent has capacity, housing, suitable circumstances
5. **The child's best interests are served by transfer** — not as punishment to the alienating parent but as the path most likely to restore the lost relationship
...
- [case-law/united-kingdom/re-c-2023-ewhc-345-fam.md](./re-c-2023-ewhc-345-fam.md)
- [case-law/united-kingdom/re-h-n-2021-ewca-civ-448.md](./re-h-n-2021-ewca-civ-448.md)
- [case-law/united-kingdom/re-s-2020-ewca-civ-568.md](./re-s-2020-ewca-civ-568.md)
- [research/harman-lorandos-2020.md](../../research/harman-lorandos-2020.md)
