---
year: 2022 Personal Status Law (Royal Decree No. M/73 — first explicit codification); previously uncodified Sharia
court: Supreme Court of Saudi Arabia + Personal Status Courts + Court of Appeal
binding_on: All Saudi courts (Sharia-based jurisdiction)
hague_1980: NOT a signatory
echr_anchor: Not applicable
brussels_iib: N/A
jurisdiction: Kingdom of Saudi Arabia
location_tags: ["saudi-arabia", "ksa", "riyadh", "jeddah", "mecca", "medina", "gulf", "gcc", "middle-east", "sharia"]
related_cases: Limited published case-law; jurisprudence under codified framework developing
citation_strength: Foundational statute (Personal Status Law 2022 — first codification)
---

# Saudi Arabia Personal Status Law 2022 — First Codification of Family Law
...
The 2022 Law codifies the traditional Sharia custody hierarchy:
- Mother has primary custody right
- If mother loses qualification, custody passes through maternal female relatives, then paternal female relatives, then male relatives

### Article 124 — Age Thresholds
Hadana traditionally ends:
- Boys: at age 9 (interpretations vary)
- Girls: at age 12 (interpretations vary)
After threshold, custody may transfer to father OR child may choose (depending on circumstances).
...
Saudi family law distinguishes between:
- **Hadana** (custody): physical care of young child — traditionally maternal
- **Wilayah** (guardianship): legal authority over major decisions (marriage, education, travel) — traditionally paternal
