---
court: Juzgados de lo Familiar + Tribunales Superiores de Justicia + Suprema Corte de Justicia de la Nación (SCJN)
jurisdiction: 
statute_name: Mexico — Código Civil Federal + Convención sobre Sustracción Internacional (Hague signatory)
last_reviewed: 2026-05-17
location_tags: ["mexico", "latin-america", "north-america", "codigo-civil", "hague-signatory", "lgdnna", "us-mexico-border", "diaspora"]
citation_strength: foundational — primary Mexican framework + critical context for US-Mexico cross-border PA cases (~37M Mexican-Americans + 1.6M US-Mexico ongoing custody disputes)
---
...
- Processing times: 6-12 months (longer than EU averages)
- Article 13(b) defense rate: moderate
- Compliance: improving but periodic State Department flags
- Cooperation with US Central Authority: established + functional
...
1. **Constitutional Article 4** — overrides any conflicting argument
2. **LGDNNA child-protection framework** — supports targeted-parent arguments + can trigger Procuraduría intervention
3. **State Civil Code patria potestad provisions** — both parents retain authority absent specific termination
4. **Suprema Corte de Justicia (SCJN) jurisprudence** — has progressively recognized PA-relevant concerns; *"Síndrome de Alienación Parental"* has been considered in Mexican appellate-level cases

For US-Mexico cross-border:

1. **File Hague immediately** if removal — Central Authority via SRE
2. **Engage Mexican family-law specialist** in parallel
3. **US State Department channels** — keep them engaged
4. **Document habitual residence** rigorously — Mexican court will require this
5. **Anticipate longer timelines** than EU Hague returns
6. **Cultural framing matters** — Mexican courts respond to family-centric arguments
...
- Citing Spanish jurisprudence ([case-law/spain/tribunal-supremo-sap-pa-doctrine.md](../spain/tribunal-supremo-sap-pa-doctrine.md)) carries weight in Mexican courts as persuasive authority
...
- [case-law/spain/tribunal-supremo-sap-pa-doctrine.md](../spain/tribunal-supremo-sap-pa-doctrine.md) — Spanish-civil-law tradition counterpart
- [statutes/brazil-lei-12318-2010.md](../../statutes/brazil-lei-12318-2010.md) — Latin American PA statutory codification
- [case-law/united-states/abbott-v-abbott-2010.md](../united-states/abbott-v-abbott-2010.md) — US Hague ne exeat
- [case-law/india/family-law-framework-non-hague.md](../india/family-law-framework-non-hague.md) — contrasting non-Hague configuration
- [posts/66-usa-parent-child-in-europe-playbook.md](../../posts/66-usa-parent-child-in-europe-playbook.md) — analogous US-EU playbook (US-Mexico mirrors many elements)
