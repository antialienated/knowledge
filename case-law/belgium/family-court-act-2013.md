---
court: Tribunal de la famille / Familierechtbank (created by this law)
jurisdiction: 
statute_name: Belgium — Loi du 30 juillet 2013 (Tribunal de la famille et de la jeunesse)
last_reviewed: 2026-05-17
location_tags: ["belgium", "europe", "eu", "family-court-act", "tribunal-de-la-famille", "familierechtbank", "procedural-unification"]
citation_strength: foundational — Belgium's unified family-court structure replacing the prior fragmented system
---
...
Pre-2013, Belgian family disputes were fragmented across:
- **Justice de Paix / Vredegerecht** — handled minor matters
- **Tribunal de Première Instance / Rechtbank van Eerste Aanleg** — handled divorce
- **Tribunal de la jeunesse / Jeugdrechtbank** — handled child-protection
- Separate chambers for different aspects of the same family situation
...
| **Procureur du Roi** | Penal Code Art. 432 criminal referrals — see [case-law/belgium/penal-code-art-432.md](./penal-code-art-432.md) |
...
| **Grandparent contact right** | [Civil Code Art. 375bis](./civil-code-art-375bis-grandparents.md) |
| **Criminal enforcement** | [Penal Code Art. 432](./penal-code-art-432.md) |
| **EU cross-border** | [Brussels IIb](../../statutes/brussels-iib-2019-1111.md) |
| **ECHR Article 8** | [Pisică v Moldova 2024](../echr/pisica-v-moldova-2024.md) + 10 other Article 8 cases |
...
- [case-law/belgium/civil-code-art-375bis-grandparents.md](./civil-code-art-375bis-grandparents.md)
- [case-law/belgium/penal-code-art-432.md](./penal-code-art-432.md)
- [case-law/netherlands/burgerlijk-wetboek-boek-1-omgangsregeling.md](../netherlands/burgerlijk-wetboek-boek-1-omgangsregeling.md) — Benelux cross-border context
