---
court: Belgian Family Courts (Tribunal de la famille / Familierechtbank)
jurisdiction: 
statute_name: Belgian Civil Code Article 375bis — Personal Right of Grandparents to Contact with Grandchildren
last_reviewed: 2026-05-16
location_tags: ["europe", "belgium", "brussels", "wallonia", "flanders", "grandparents", "civil-code", "article-375bis"]
citation_strength: foundational — primary statutory authority for grandparent contact rights in Belgium
---

# Belgian Civil Code Article 375bis — Grandparents' Right to Contact
...
This dual-track strategy can:
- Preserve the child's bond with the targeted-parent side of the family
- Generate independent witness evidence of alienating behaviors
- Create a documented contact pattern that supports the targeted parent's broader case
- Provide the child with a safe, lower-conflict adult relationship during litigation
...
- [case-law/united-states/troxel-v-granville-2000.md](../united-states/troxel-v-granville-2000.md)
- [posts/47-grandparents-pa.md](../../posts/47-grandparents-pa.md)
