---
year: 2002 (Simeyniy Kodeks); 2017 + 2023 wartime amendments
court: Verkhovnyi Sud (Supreme Court) + Constitutional Court
binding_on: All Ukrainian courts (national family code)
hague_1980: Signatory (continuing application despite displacement)
echr_anchor: Article 8 ECHR (Ukraine remains party despite Russian withdrawal context)
brussels_iib: Non-EU (candidate state since 2022)
jurisdiction: Ukraine
location_tags: ["ukraine", "ukraina", "kyiv", "kiev", "lviv", "odesa", "kharkiv", "displaced-persons"]
related_cases: ["VS Postanova 580/2020", "Hunt v Ukraine HUDOC", "Mansur Yalcin v Turkey (cited)"]
citation_strength: Foundational statute (Simeyniy Kodeks 2002)
---

# Ukraina Simeyniy Kodeks — Batkivski Prava
...
When parents do not live together, the court determines the child's residence considering:
...
- The child's wishes (from age 10, mandatory hearing)
...
The Ukrainian Supreme Court has issued specific guidance on PA cases complicated by:
- Displacement (one parent in Ukraine, other in EU host country)
- Mobilization status of fathers (cannot leave Ukraine)
- Children evacuated to EU then alleged "abducted" by accompanying parent
- Hague return cases now strongly contested on Art. 13(b) grave-risk grounds

## ECHR Context

Ukraine party to ECHR since 1997. Notable Strasbourg jurisprudence:
- **Hunt v Ukraine (2006)**: Article 8 violation for failure to enforce contact
- **Vyshnyakov v Ukraine (2018)**: Art. 8 violation for prolonged contact-enforcement failure
- **Strumia v Italy line cited extensively by Ukrainian courts
...
- [HUDOC search: Yalcin](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Yalcin%22]})
