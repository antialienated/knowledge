...
case_name: Strumia v. Italy
date_decided: 2016-06-23
jurisdiction: 
last_reviewed: 2026-05-16
location_tags: ["europe", "italy", "echr", "strasbourg", "article-8", "exceptional-diligence", "italian-line", "enforcement"]
application_no: 53377/13
citation_strength: landmark — established the "exceptional diligence" standard for state enforcement of contact orders
---
...
1. **Exceptional diligence** is the standard — not ordinary diligence
2. **All available enforcement measures** must be considered + deployed
3. **The State's response must be proportionate** to the documented obstruction
4. **Time is a measurable harm** — delay itself is part of the violation
