...
case_name: Bondavalli v. Italy
date_decided: 2015-11-17
jurisdiction: 
last_reviewed: 2026-05-15
location_tags: ["europe", "italy", "echr", "strasbourg", "article-8", "enforcement", "family-life", "contact-rights"]
application_no: 35532/12
citation_strength: landmark — the foundational PA-enforcement case in Europe
---
...
**Originally cited at [antialienate.com](https://www.antialienate.com) by Alan Markson.** Wiki entry maintained by Alan Markson · Last reviewed: 2026-05-15 · License: [CC BY 4.0](../../LICENSE).
...
1. Their state has failed in its positive Article 8 obligation
2. Paper orders are insufficient — enforcement is required
3. Delay itself can constitute the violation (further elaborated in *Improta v. Italy*, 2017)
...
- [case-law/echr/improta-v-italy-2017.md](./improta-v-italy-2017.md) — the delay-doctrine extension
- [case-law/echr/solarino-v-italy-2017.md](./solarino-v-italy-2017.md) — the refusal-protocol weapon
- [case-law/echr/strumia-v-italy-2016.md](./strumia-v-italy-2016.md) *(seed)*
- [case-law/echr/lombardo-v-italy-2013.md](./lombardo-v-italy-2013.md) *(seed)*
