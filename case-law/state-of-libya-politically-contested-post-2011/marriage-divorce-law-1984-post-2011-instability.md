---
year: 1984 Marriage and Divorce Law (Law 10/1984); pre-2011 stable framework; post-2011 instability complicates
court: Supreme Court of Libya + Cour d'Appel + Family Court divisions (operational status varies)
binding_on: All Libyan courts (where functional); regional variations under instability
hague_1980: NOT a signatory
echr_anchor: Not applicable
brussels_iib: N/A
jurisdiction: State of Libya (politically contested post-2011)
location_tags: ["libya", "tripoli", "benghazi", "africa", "north-africa", "maghreb", "arabic", "instability-context"]
related_cases: Limited published case-law; post-2011 jurisprudence fragmented
citation_strength: Foundational statute (Marriage and Divorce Law 1984 Law 10/1984 + 1973 Personal Status Law)
---
...
Where statutory law is silent, Maliki Sunni Sharia applies. Custody thresholds:
- Boys: traditionally to age 7 (mother's hadana)
- Girls: traditionally to puberty (~9)
- After thresholds: father's wilayah (legal guardianship) operates
...
Libya family-law practice:
- ~7M population (~96% Muslim — Maliki Sunni)
- Strong tribal + extended-family role (especially in non-urban areas)
- Post-2011 emigration wave (~1M Libyans abroad, especially in Tunisia, Egypt, Italy, UK, Germany)
- Bilingual practice (Arabic primary; some French/Italian influence in legal commentary)
...
Libya is NOT a Hague 1980 signatory, and the post-2011 instability severely aggravates cross-border PA complications:
- Wrongful retention in Libya: no Hague return mechanism + court enforcement unreliable
- Bilateral cooperation severely limited
- Sanctions/security-zone considerations may apply
- Foreign embassies provide limited consular assistance
...
Post-2011 Libyan emigration has concentrated in:
- Tunisia (~250K Libyans, sometimes temporary)
- Egypt (~200K)
- Italy (~30K — historical + Mediterranean route)
- UK (~30K)
- Germany (~25K)
