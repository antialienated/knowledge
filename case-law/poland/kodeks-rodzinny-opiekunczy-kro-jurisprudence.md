---
year: 1964 KRO; major 2008 reform (Ustawa o wspieraniu rodziny); 2015 + 2023 amendments
court: Sad Najwyzszy (Supreme Court) + Trybunal Konstytucyjny (Constitutional Tribunal)
binding_on: All Polish courts (national family code)
hague_1980: Signatory
echr_anchor: Article 8 ECHR
brussels_iib: EU member
jurisdiction: Poland
location_tags: ["poland", "polska", "warsaw", "warszawa", "krakow", "gdansk", "wroclaw", "poznan"]
related_cases: ["SN III CZP 80/13", "SN IV CSK 22/16", "P. and S. v Poland HUDOC"]
citation_strength: Foundational statute (Kodeks Rodzinny i Opiekunczy 1964 + 2008 + 2015 reforms)
---

# Polska Kodeks Rodzinny i Opiekunczy (KRO) — Wladza Rodzicielska
...
Poland party to ECHR since 1993. Notable Strasbourg condemnations:
- **P. and S. v Poland (2012)**: Article 8 violation for failure to protect family life
- **Pakhomova v Poland (2018)**: failure to enforce contact in alienation context
- **Sliwa v Poland**: positive-obligation case repeatedly cited by Polish courts
...
- [HUDOC search: Pakhomova](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Pakhomova%22]})
- [HUDOC search: Sliwa](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Sliwa%22]})
