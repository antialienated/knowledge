...
jurisdiction: 
statute_name: Family Law Act 1975 (Cth), Section 60CC — Best Interests of the Child
last_reviewed: 2026-05-16
location_tags: ["australia", "federal", "family-law-act", "s60cc", "best-interests", "fcfcoa", "post-2024-amendments"]
citation_strength: foundational — primary Australian statutory framework for best-interests analysis in PA cases
---
...
The 2023 Amendment removed:
- The "equal shared parental responsibility" presumption (Old s61DA)
- The "two primary considerations / additional considerations" split
- The "equal time / substantial and significant time" cascade
...
When the child expresses views that appear coached, the court is required to consider:
- The child's maturity + understanding
- The reliability of the views (implicitly: source-of-views analysis)
- The risk of treating coached views as authentic preferences

This aligns with the ECHR Solarino v. Italy doctrine — courts cannot rubber-stamp coached refusal. See [case-law/echr/solarino-v-italy-2017.md](../echr/solarino-v-italy-2017.md).
...
- [Difference Between Safety Comfort Reintegration](https://www.antialienate.com/blog/difference-between-safety-comfort-reintegration)
