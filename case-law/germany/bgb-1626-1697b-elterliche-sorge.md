---
year: 1896 originating BGB; major Kindschaftsrechtsreform 1998; FamFG 2009
court: Bundesgerichtshof (BGH) + Bundesverfassungsgericht (BVerfG)
binding_on: All German courts (federal civil code)
hague_1980: Signatory
echr_anchor: Article 8 ECHR
brussels_iib: EU member
jurisdiction: Germany
location_tags: ["germany", "deutschland", "berlin", "munich", "hamburg", "koln", "frankfurt", "dusseldorf"]
related_cases: ["BGH XII ZB 565/15", "BVerfG 1 BvR 16/13", "Sahin v Germany ECHR", "Sommerfeld v Germany ECHR"]
citation_strength: Foundational statute (Burgerliches Gesetzbuch)
---
...
Germany has been condemned multiple times under Article 8 in PA contexts:
- **Sahin v Germany [GC] (2003)**: failure to hear child + restrictive contact interpretation
- **Sommerfeld v Germany [GC] (2003)**: companion to Sahin
- **Hoffmann v Austria (cited): doctrine applies to Germany
- **Zaunegger v Germany (2009)**: § 1626a unmarried-fathers discrimination
- **Buchleither v Germany (cited): enforcement obligation
- **Anayo v Germany (2010)**: § 1685 grandparent + biological-father contact
...
- [HUDOC search: Buchleither](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Buchleither%22]})
