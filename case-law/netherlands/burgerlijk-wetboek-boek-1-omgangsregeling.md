---
court: Rechtbanken + Hoge Raad der Nederlanden
jurisdiction: 
statute_name: "Netherlands — Burgerlijk Wetboek Boek 1 (Civil Code Book 1): Ouderlijke Verantwoordelijkheid + Omgangsregeling"
last_reviewed: 2026-05-17
location_tags: ["netherlands", "europe", "eu", "burgerlijk-wetboek", "bw-boek-1", "omgangsregeling", "ouderlijk-gezag", "hoge-raad", "hague-signatory"]
citation_strength: foundational — primary Dutch statutory framework for parental responsibility + contact-rights enforcement
---
...
Contact may only be denied where:
- (a) Contact would result in serious harm to the child's mental or physical development
- (b) The parent is manifestly unsuitable or unable
- (c) Contact is contrary to overriding interests of the child
- (d) The child of 12+ has serious objections — but court must investigate basis
...
Dutch family courts can impose:
- Dwangsom (financial penalty for non-compliance)
...
1. **Child-right framing of contact** — alienating parent cannot frame obstruction as "protecting" the child without serious justification
2. **High threshold for denial** (Art. 377a(3)) — coached refusal alone insufficient
3. **Duty to investigate basis** (Art. 377a(3)(d)) — Hoge Raad has progressively required courts to look beyond stated wishes
4. **Dwangsom enforcement** — court can impose daily financial penalties for non-compliance
5. **ECHR Article 8 directly applicable** — full ECHR jurisprudence (Bondavalli, Improta, Solarino, Pisică) cited as binding authority
...
The Dutch position aligns with:
- *Solarino v Italy* (ECHR 2017) — no rubber-stamping
- *BGH XII ZB 565/15* (Germany 2018) — source-investigation duty
- *Cass civ 1ère 22 mars 2023* (France) — source-investigation duty

## The Belgium-Netherlands cross-border context

Belgium-Netherlands cross-border PA cases are common given:
- Shared Dutch language (Flemish in Belgium)
- High geographic mobility within Benelux
- Same EU framework (Brussels IIb directly applies — see [statutes/brussels-iib-2019-1111.md](../../statutes/brussels-iib-2019-1111.md))
- Comparable family-law traditions
...
- [case-law/belgium/civil-code-art-375bis-grandparents.md](../belgium/civil-code-art-375bis-grandparents.md)
- [case-law/belgium/penal-code-art-432.md](../belgium/penal-code-art-432.md)
- [case-law/germany/bgh-xii-zb-565-2018.md](../germany/bgh-xii-zb-565-2018.md)
- [statutes/brussels-iib-2019-1111.md](../../statutes/brussels-iib-2019-1111.md)
- [case-law/echr/pisica-v-moldova-2024.md](../echr/pisica-v-moldova-2024.md)
