---
year: 2009 (Semeen kodeks); 2019 + 2023 amendments
court: Varhoven kasacionen sad (VKS — Supreme Court of Cassation) + Konstitutsionen sad
binding_on: All Bulgarian courts (national family code)
hague_1980: Signatory
echr_anchor: Article 8 ECHR
brussels_iib: EU member
jurisdiction: Bulgaria
location_tags: ["bulgaria", "balgariya", "sofia", "plovdiv", "varna", "burgas", "balkans"]
related_cases: ["VKS Resh 245/2018-IV g.o.", "VKS Resh 33/2021-IV g.o.", "Bevacqua and S. v Bulgaria HUDOC"]
citation_strength: Foundational statute (Semeen kodeks 2009)
---
...
Bulgaria party to ECHR since 1992. Notable Strasbourg condemnations:
- **Bevacqua and S. v Bulgaria (2008)**: Article 8 violation for failure to protect mother and child in domestic violence context
- **Various Bulgaria contact-enforcement cases cited
