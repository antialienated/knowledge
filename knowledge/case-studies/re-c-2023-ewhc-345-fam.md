---
title: Re C ('Parental Alienation'; Instruction of Expert) [2023] EWHC 345 (Fam)
section: case-studies
summary: "Neutral citation: 2023 EWHC 345 Fam Court: High Court of Justice, Family Division, sitting on appeal from the Family Court at first instance HH Judge Lindsay Davies ; Case No FA-2022-00227 Decided: 20"
last_verified: 2026-09-25
tags: []
canonical: "https://antialienate.com/knowledge/case-studies/re-c-2023-ewhc-345-fam"
---
...
* **Charlotte [Baker](https://pubmed.ncbi.nlm.nih.gov/?term=Baker+AJL+parental+alienation)** (Junior counsel) — instructed by Dawson Cornwell LLP for ACP-UK (Association of Clinical Psychologists-UK), intervener
...
> The single issue upon which the appeal is based is that relating to Ms A's qualification to undertake the role of expert assigned to her in this case. It is correct that, since June 2021, when the fact finding judgment was given, there have been developments in terms of guidance which focus upon the need for caution when instructing experts in Family proceedings. Reference has been made to the ACP guidance, and the FJC/[BPS](https://www.bps.org.uk/) guidance, and to the President's Memorandum, to which reference was made in a speech in Jersey. This new material is important and should be read and understood by professionals and judiciary in the Family Court, but it is no more than guidance or advice. It is neither black-letter law nor regulation, and it does not, of itself, render unlawful that which was previously accepted, or, more particularly, render 'unqualified' an individual who was previously thought to be qualified to act as an expert.

<https://www.bailii.org/ew/cases/EWHC/Fam/2023/345.html>

**[87]** (en):

> I start with basic concepts and labels. There is no definition of an 'expert' in Family proceedings, save for the circular procedural definition at FPR 2010, r 23.2©: "'expert' means a person who provides expert evidence for use in proceedings".
...
* **Re H-N (Children) (Domestic Abuse: Finding of Fact Hearings) [2021] EWCA Civ 448** (UK-EWS) — [`re-h-n-2021-ewca-civ-448`](../re-h-n-2021-ewca-civ-448/) — Court of Appeal (Sir Andrew McFarlane P, King LJ, Holroyde LJ) on findings of fact in DA-framed private-law proceedings. Re C explicitly maps the ACP-UK 'alienation is a question of fact' formulation onto the parallel DA-fact-finding regime that Re H-N established. Re H-N is the procedural anchor (fact-find DA properly); Re C is the expert-quality gateway (regulated psychology only, with a short reasoned record where unregistered).
* **Re Y (Experts and Alienating Behaviour: The Modern Approach) [2026] EWFC 38** (UK-EWS) — [`re-y-2026-ewfc-38`](../re-y-2026-ewfc-38/) — Sir Andrew McFarlane P sets aside first-instance findings of 'alienating behaviour' built on the report of Ms Melanie Gill, who was not on the [HCPC](https://www.hcpc-uk.org/) Practitioner Psychologist register and not a Chartered Member of the [BPS](https://www.bps.org.uk/). Re Y operationalises the Re C guidance into a set-aside remedy: where the instructing court did not give the 'short judgment' required by Re C [98] on why it was appropriate to instruct an unregulated psychologist, findings dependent on that evidence are vulnerable on appeal.
...
* **[BVerfG](https://www.bundesverfassungsgericht.de/) 17.11.2023 — 1 BvR 1076/23** (DE) — [`bverfg-1-bvr-1076-23-germany-2023`](../bverfg-1-bvr-1076-23-germany-2023/) — German Federal Constitutional Court constitutional critique of PAS-based Sachverständigengutachten in custody proceedings — civil-law parallel to Re C on different doctrinal grounds (Art. 6 Abs. 2 GG / Kindeswohl constitutional protection rather than [HCPC](https://www.hcpc-uk.org/) registration). Together with Re C and the OLG Frankfurt 7 UF 88/25 companion case, [BVerfG](https://www.bundesverfassungsgericht.de/) 1 BvR 1076/23 describes the European convergence on regulated-expert-only PA evidence.
* **[Cassazione](https://www.cortedicassazione.it/) Civ. n. 9691/2022** (IT) — [`cassazione-9691-2022-italy`](../cassazione-9691-2022-italy/) — Italian Court of Cassation requirement that PA findings rest on scientifically validated methodology — the civil-law analogue to Re C's [HCPC](https://www.hcpc-uk.org/)-registration gateway, polices the same upstream evidential quality.
* **NF v AF [2025] CSOH 13 (Lord Stuart)** (UK-SCO) — [`nf-v-af-2025-csoh-13-scotland`](../nf-v-af-2025-csoh-13-scotland/) — Scottish Outer House PA-framed proceedings in which the expert was a Chartered Clinical Psychologist whose evidence was 'unchallenged' (para [31]) — the kind of regulated-expert evidence base that Re C identifies as the gateway for findings of alienating behaviour.
...
* [Cafcass](https://www.cafcass.gov.uk/) safeguarding and welfare-reporting practice updates aligning the [Cafcass](https://www.cafcass.gov.uk/) Alienation Tool (referenced in HHJ Davies's first-instance judgment) with the Re C-FJC line on alienating behaviour as a question of fact for the court.
...
1. **Re C ('parental Alienation'; Instruction of Expert) [2023] EWHC 345 (Fam) (21 February 2023) — [BAILII](https://www.bailii.org/) listing** — <https://www.bailii.org/ew/cases/EWHC/Fam/2023/345.html> ([BAILII](https://www.bailii.org/) (British and Irish Legal Information Institute)) [en] — accessed 2026-05-30
...
16. **Kennedy v Cordia (Services) LLP (Scotland) [2016] UKSC 6** — <https://www.bailii.org/uk/cases/UKSC/2016/6.html> ([BAILII](https://www.bailii.org/) / [UK Supreme Court](https://www.supremecourt.uk/)) [en] — accessed 2026-05-30
17. **Re A (A Child: Supervised Contact) (s 91(14) [Children Act 1989](https://www.legislation.gov.uk/ukpga/1989/41) Orders) [2021] EWCA Civ 1749** — <https://www.bailii.org/ew/cases/EWCA/Civ/2021/1749.html> ([BAILII](https://www.bailii.org/)) [en] — accessed 2026-05-30
...
* Comparative jurisprudence: [BVerfG](https://www.bundesverfassungsgericht.de/) 1 BvR 1076/23 (Germany, 17.11.2023) and [Cassazione](https://www.cortedicassazione.it/) 9691/2022 (Italy) are included as civil-law parallels to the regulated-expert-only line, consistent with the AntiAlienate UK-arc house style across the Re H-N, Re S and Re Y entries.
* Subsequent reception: the principal FJC follow-on is the December 2024 finalised FJC guidance on responding to allegations of alienating behaviour, which the PFD's referral at paragraphs 99, 102 and 107 effectively commissioned. The [Cafcass](https://www.cafcass.gov.uk/) operational update and the practitioner-chambers analyses (1 Garden Court / Mishcon / Trinity / Becket / Expert Witness Journal / iFLG) round out the reception layer.
