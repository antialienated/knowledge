---
title: BVerfG 17.11.2023 – 1 BvR 1076/23
section: case-studies
summary: "ECLI: ECLI:DE:BVerfG:2023:rk20231117.1bvr107623 Court: Bundesverfassungsgericht 2. Kammer des Ersten Senats Decided: 2023-11-17 Panel: Ott / Radtke / Wolff unanimous Kammerbeschluss Why this case matt"
last_verified: 2026-09-25
tags: []
canonical: "https://antialienate.com/knowledge/case-studies/bverfg-1-bvr-1076-23-germany-2023"
---
...
* **Kerstin Bielefeld** (Rechtsanwältin) — Köln for mother

## Experts

* **Sachverständige (2020 Gutachten)** — family-court forensic Sachverständige (instructed by Amtsgericht below)

## Holding

A family-court order is constitutionally untenable to the extent it relies on a Sachverständigengutachten whose reasoning is grounded in the PAS construct. PAS is regarded in the scientific literature as refuted ("überkommene und fachwissenschaftlich als widerlegt geltende Konzept"), and a Gutachten resting on it is not a sufficiently sound basis ("hinreichend tragfähige Grundlage") for a Kindeswohl-oriented decision under Art. 6 Abs. 2 GG.
...
*Translation:* The decision does not currently appear correct on other simple-statutory grounds either. The Oberlandesgericht's recourse to 'parent-child alienation' falls back on the outdated concept of so-called Parental Alienation Syndrome (PAS), which is regarded in the relevant scientific literature as refuted. That does not suffice as a sufficiently sound basis for a decision oriented to the child's welfare. So far as can be seen, there is currently no empirical evidence in the scientific literature for parental manipulation in cases of a child's rejection of the other parent, or for the effectiveness of removing the child from the household of the allegedly manipulating parent (see comprehensively Zimmermann/Fichtner/Walper/Lux/Kindler, in: ZKJ 2023, p. 43 ff., and same, in: ZKJ 2023, p. 83 ff.).

<https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2023/11/rk20231117_1bvr107623.html>

## Outcome

OLG Köln Beschlüsse vom 8.5.2023 und 17.5.2023 (II-25 UF 19/23) aufgehoben; Sache zurückverwiesen.
...
* **OLG Frankfurt 7 UF 88/25** (DE) — [`olg-frankfurt-7-uf-88-25-germany-2026`](../olg-frankfurt-7-uf-88-25-germany-2026/) — Companion German OLG decision (Jan 2026) that operationalises this [BVerfG](https://www.bundesverfassungsgericht.de/) ruling at OLG level via Sachverständigen-Mindestanforderungen.
...
* Identities of the 2020 Sachverständige and the two Verfahrensbeistände are not stated in the published Kammerbeschluss; preserved as anonymised.
* Identities of the children are anonymised by the Court; placeholders Kind 1 / Kind 2 used.
* Composition of the OLG Köln Beschwerdesenat that issued the impugned orders is not in the Kammerbeschluss text.
* No discrete DGPs or BPtK press release specifically welcoming this decision by case number was located; the existing DJI/ZKJ literature pre- and post-dating the decision serves as the institutional critique register.
* GREVIO 2022 Germany paragraph numbers on alienation framing are flagged as out of scope for this case study.
