---
title: Contributing to the AntiAlienate Knowledge Base
section: contributing
summary: "This repository's credibility rests on a single principle: every load-bearing claim must be traceable to a primary source . Contributors and maintainers alike must follow the editorial standards below"
last_verified: 2026-09-25
tags: []
canonical: "https://antialienate.com/knowledge/contributing"
---
# Contributing to the AntiAlienate Knowledge Base
...
* **Identify what is empirically established vs. what is contested.** Use clear confidence-level language (e.g., the [evidence base](../evidence/pa-as-child-abuse/) has explicit "high confidence / moderate / low confidence" sections).
...
- The page URL and the specific paragraph
- The error
- The primary-source citation that supports the correction
...
See the [case studies open gaps](../case-studies/#honest-gaps--wanted-contributions) and the [evidence section coming-next list](../evidence/#coming-next). Particularly wanted:
