---
title: "Diagnostic Codes That DO Apply to Parental-Alienating Conduct: A Primary-Source Evidence Base"
section: evidence
summary: Purpose. A primary-source, citation-led evidence page on the existing DSM-5 / DSM-5-TR and ICD-11 diagnostic codes that can defensibly be used to capture parental-alienating conduct and its sequelae ,
last_verified: 2026-09-25
tags: []
canonical: "https://antialienate.com/knowledge/evidence/diagnostic-codes-that-apply"
---
...
>
> **Honest disclosure (load-bearing).** The [DSM-5](https://www.appi.org/products/dsm) and [ICD-11](https://icd.who.int/) are copyrighted. Several URLs that hold primary text returned HTTP 403, paywalls, or copyright refusals during compilation. The verbatim [DSM-5](https://www.appi.org/products/dsm) / [ICD-11](https://icd.who.int/) quotations in this page were assembled from multiple secondary academic sources that quote them consistently; readers using these quotations in court should verify against the published [DSM-5-TR](https://www.appi.org/products/dsm) (2022) and [ICD-11](https://icd.who.int/) MMS browser (<https://icd.who.int/browse11/l-m/en>) before filing.

---

## 1. The [DSM-5](https://www.appi.org/products/dsm) / [DSM-5-TR](https://www.appi.org/products/dsm) codes that apply
...
2. to **parental intimate partner violence**;
...
- Caregiver-child relationship problem with current caregiver
- Caregiver-child relationship problem with former caregiver
...
- court-citable codes (so the diagnosis line survives cross-examination);
- *Daubert* / *Frye* defensibility (the codes themselves are in published, peer-reviewed diagnostic manuals);
- room for the clinician to describe the behavioural dynamic accurately in narrative without overstating the diagnostic claim.
...
These two 2015 *Family Process* papers are the methodological backbone for the proposition that the [DSM-5](https://www.appi.org/products/dsm) relational-problem and maltreatment codes have field-tested reliability adequate for forensic use.
...
- Use a "multiple hypotheses" assessment approach, considering all potential factors impacting the child's relationship with a rejected parent, to avoid simplified attribution of blame.
- False positives (mislabelling estrangement as alienation) and false negatives (missing alienation in the presence of authentic safety concerns) are both clinically and forensically harmful.
...
Jean Mercer (developmental psychology) and Joyanna Silberg (child trauma specialist) have argued in the peer-reviewed literature that:
- Parental alienation criteria are vague, subjective, and inconsistent with a child-centred evaluation; see Mercer, J. (2021). Examining Parental Alienation Treatments: Problems of Principles and Practices, *Child and Adolescent Social Work Journal*, <https://link.springer.com/article/10.1007/s10560-019-00625-8>.
- Practitioners attributing child reports of abuse to "alienation" have caused documented harm: Silberg's case-series analysis of 27 cases where alienation findings were later reversed because of confirmed abuse documented children suffering anxiety, depression, PTSD, self-harm, and suicidality. **[secondary verification only]** — primary case-series publication: Silberg, J., & Dallam, S. (2019). Abusers gaining custody in family courts: A case series of overturned decisions, *Journal of Child Custody*, 16(2), 140–169 (citation to be re-verified).
...
The mainstream clinical pathway for a child presenting with the constellation captured by CAPRD + (where applicable) child psychological abuse codes includes:
- Trauma-focused cognitive-behavioural therapy (TF-CBT) where the child meets PTSD or sub-PTSD criteria;
- Family therapy involving both parents and the child, subject to safety screening for inter-parental violence;
- Reunification-style interventions where appropriate after differential-diagnosis ruling-out of estrangement secondary to maltreatment by the rejected parent (cross-reference `/evidence/reunification-outcomes.md` for the substantial caveats on the evidence base for intensive reunification interventions).
...
* The [DSM-5](https://www.appi.org/products/dsm) textual examples ("berating, disparaging, or humiliating the child"; "scapegoating of the child"; "unwarranted feelings of estrangement").
...
**Primary [DSM-5](https://www.appi.org/products/dsm) / [DSM-5-TR](https://www.appi.org/products/dsm) sources.**
