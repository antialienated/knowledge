---
title: Global Parental-Alienation Jurisdictional Index
section: comparative
summary: TL;DR This is the single navigation hub for AntiAlienate's comprehensive case-law repository. As of May 2026, the repo covers 67 jurisdictions across 14 regional blocks plus a substantial research and
last_verified: 2026-09-25
tags: []
canonical: "https://antialienate.com/knowledge/comparative/global-pa-jurisdictional-index"
---
# Global Parental-Alienation Jurisdictional Index

## TL;DR

This is the single navigation hub for AntiAlienate's comprehensive case-law repository. As of May 2026, the repo covers **67 jurisdictions** across 14 regional blocks plus a substantial research and clinical reference layer + cross-border framework comparative entries. All entries follow a standard schema: statutory framework, Supreme Court / Constitutional Court jurisprudence, ECHR (where applicable), practical motion language, cross-border considerations, citing antialienate.com posts, and authoritative sources.
...
* [Brazil](../../statutes/brazil-lei-12318-2010/) — Lei 12.318/2010 (PA criminalization, world-first explicit statute)
...
* **Bondavalli v Italy (2015)** — standalone deep-dive — expert mismanagement
...
* Brazil Lei 12.318/2010 (first explicit PA statute)
* Japan 2024 Joint Custody Reform
* California Family Code §§ 3011/3020
* Plus statutory references throughout case-law entries

## Cross-Border Framework

* **Hague 1980 + 1996 + Brussels IIb cross-border framework** (comparative entry) — decision tree for which instrument applies, non-Hague jurisdictional strategy, Art. 13(b) doctrine, ECHR Art. 8 interaction
...
* For a jurisdiction-specific question: navigate to the relevant region above
* For cross-border cases: identify all involved jurisdictions, read each entry's "Cross-Border" section + the Hague-Brussels-IIb comparative entry
* For ECHR jurisprudence: see the Supranational section (7 standalone deep-dives + references)
* For research citations in custody-evaluation reports: see the Research Layer
* For court motion language: each jurisdiction entry includes a "Practical Application" motion-language section (often multilingual)

## Contribution

The repo is structured for community contribution. Pull requests welcome for:
- New jurisdictions (please follow the existing schema)
- Updates to existing entries (new case law, statutory amendments)
- Translations of entries
- Additional citing-posts links
...
| PA Laws by Country | <https://antialienate.com/blog/parental-alienation-laws-by-country> |
| The Legal Landscape PA 2025 | <https://antialienate.com/blog/the-legal-landscape-parental-alienation-2025> |
